...
public class EncryptionDecryptionWithMap {
    ...
    public static void main(String[] args) {
    	try {
    		EncryptionDecryptionWithMap encryptionDecryptionWithMap = new EncryptionDecryptionWithMap();
    		encryptionDecryptionWithMap.init();
    		Map<String, String> message = new HashMap<>();
    		message.put("Name", "vikash");
    		message.put("Address", "Pune");
    		String encryptedMessage = encryptionDecryptionWithMap.encrypt(message);
    		Map<String, String> decryptedMessage = encryptionDecryptionWithMap.decrypt(encryptedMessage);
